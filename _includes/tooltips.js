tippy('#about', {
    ...
    placement: 'auto',
    touch: ['hold', 500],
    content: '<div class="col-5 col-s-9 article-content">
<h1>David Laing</h1>
<div class="home">
<p>
        Welcome! I'm David Laing.
    </p>
</div>
</div>'});
...
tippy('#about', {
    ...
    content: '<div class="col-5 col-s-9 article-content">
<h1>Example 2</h1>
<p>Lacinia quis vel eros donec ac odio <a class="internal-link" href="/about/" id="about">About</a>. Diam volutpat commodo sed egestas egestas fringilla phasellus faucibus. Ullamcorper a lacus vestibulum sed. Massa enim nec dui nunc. Mi ipsum faucibus vitae aliquet nec ullamcorper. Quis risus sed vulputate odio ut enim blandit. A scelerisque purus semper eget duis. Urna porttitor rhoncus dolor purus non enim. Nisi vitae suscipit tellus mauris. A arcu cursus vitae congue mauris rhoncus aenean vel elit. Posuere morbi leo urna molestie at elementum. Feugiat nisl pretium fusce id. Sagittis purus sit amet volutpat consequat. Diam quam nulla porttitor massa. Hac habitasse platea dictumst quisque sagittis. Ut ornare lectus sit amet est placerat in.</p>
